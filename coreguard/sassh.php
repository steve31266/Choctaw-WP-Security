...
define( 'CHOCTAW_WP_SECURITY_VERSION', '1.9.3.7' );
...
require_once CHOCTAW_WP_SECURITY_PATH . 'includes/class-sassh-option-key-normalizer.php';
...
require_once CHOCTAW_WP_SECURITY_PATH . 'includes/class-sassh-post-key-normalizer.php';
